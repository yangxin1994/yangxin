# encoding: utf-8
require 'encryption'
class TempTwoMailer < ActionMailer::Base
	layout 'email'

	default from: "\"优数调研\" <postmaster@two.mailgun.org>", charset: "UTF-8"
	...
	self.smtp_settings =
	{
		...
		:port           => 25,
		:domain         => "two.mailgun.org",
		:user_name      => "postmaster@two.mailgun.org",
		:password       => "1vf5ws26lhy9",
