# encoding: utf-8
require 'encryption'
class TempSevenMailer < ActionMailer::Base
	layout 'email'

	default from: "\"优数调研\" <postmaster@seven.mailgun.org>", charset: "UTF-8"
	...
	self.smtp_settings =
	{
		...
		:port           => 25,
		:domain         => "seven.mailgun.org",
		:user_name      => "postmaster@seven.mailgun.org",
		:password       => "05wjblhipfq2",
