# encoding: utf-8
require 'encryption'
class TempFiveMailer < ActionMailer::Base
	layout 'email'

	default from: "\"优数调研\" <postmaster@five.mailgun.org>", charset: "UTF-8"
	...
	self.smtp_settings =
	{
		...
		:port           => 25,
		:domain         => "five.mailgun.org",
		:user_name      => "postmaster@five.mailgun.org",
		:password       => "62r8-i6g6td0",
