# encoding: utf-8
require 'encryption'
class TempTenMailer < ActionMailer::Base
	layout 'email'

	default from: "\"优数调研\" <postmaster@ten.mailgun.org>", charset: "UTF-8"
	...
	self.smtp_settings =
	{
		...
		:port           => 25,
		:domain         => "ten.mailgun.org",
		:user_name      => "postmaster@ten.mailgun.org",
		:password       => "5s5mrrtaufh7",
