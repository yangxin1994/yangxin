# encoding: utf-8
require 'encryption'
class TempThreeMailer < ActionMailer::Base
	layout 'email'

	default from: "\"优数调研\" <postmaster@three.mailgun.org>", charset: "UTF-8"
	...
	self.smtp_settings =
	{
		...
		:port           => 25,
		:domain         => "three.mailgun.org",
		:user_name      => "postmaster@three.mailgun.org",
		:password       => "8hupn2-6z1s8",
