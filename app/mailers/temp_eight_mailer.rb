# encoding: utf-8
require 'encryption'
class TempEightMailer < ActionMailer::Base
	layout 'email'

	default from: "\"优数调研\" <postmaster@eight.mailgun.org>", charset: "UTF-8"
	...
	self.smtp_settings =
	{
		...
		:port           => 25,
		:domain         => "eight.mailgun.org",
		:user_name      => "postmaster@eight.mailgun.org",
		:password       => "7lqi9xt5fwj2",
