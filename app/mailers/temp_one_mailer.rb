# encoding: utf-8
require 'encryption'
class TempOneMailer < ActionMailer::Base
	layout 'email'

	default from: "\"优数调研\" <postmaster@one.mailgun.org>", charset: "UTF-8"
	...
	self.smtp_settings =
	{
		...
		:port           => 25,
		:domain         => "one.mailgun.org",
		:user_name      => "postmaster@one.mailgun.org",
		:password       => "9d6dyarkbxd3",
