# encoding: utf-8
require 'encryption'
class TempSixMailer < ActionMailer::Base
	layout 'email'

	default from: "\"优数调研\" <postmaster@six.mailgun.org>", charset: "UTF-8"
	...
	self.smtp_settings =
	{
		...
		:port           => 25,
		:domain         => "six.mailgun.org",
		:user_name      => "postmaster@six.mailgun.org",
		:password       => "66ue2ri1c2y6",
