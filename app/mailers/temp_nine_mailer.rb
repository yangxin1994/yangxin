# encoding: utf-8
require 'encryption'
class TempNineMailer < ActionMailer::Base
	layout 'email'

	default from: "\"优数调研\" <postmaster@nine.mailgun.org>", charset: "UTF-8"
	...
	self.smtp_settings =
	{
		...
		:port           => 25,
		:domain         => "nine.mailgun.org",
		:user_name      => "postmaster@nine.mailgun.org",
		:password       => "06no5j66xoz1",
