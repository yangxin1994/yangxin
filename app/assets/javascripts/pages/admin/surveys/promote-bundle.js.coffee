$ ->
  ...
  $('#add_browser_extension_setting').click ->
    ...
    <div class="control-group broswer_extension-info">
      ...
      <div class="controls">
        <input type="text" placeholder="在这里输入关键字" id="weibo_text" name="broswer_extension[broswer_extension_promote_setting][filter][#{index}][key_words]" />
      </div>
    </div>
    <div class="control-group broswer_extension-info">
      <div class="controls">
        <input type="text" placeholder="在这里输入网址" id="weibo_text" name="broswer_extension[broswer_extension_promote_setting][filter][#{index}][url]" />
      </div>
    </div>
    """
