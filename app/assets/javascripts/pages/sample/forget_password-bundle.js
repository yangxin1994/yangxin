...
$(function(){
  ...
  function re_mail(mail){
    $.getJSON('/account/send_forget_pass_code.json',{ email_mobile:mail},function(retval){
      if(retval.success){
  ...
  function send_activate_code(button,account){
    $.getJSON('/account/send_forget_pass_code.json',{ email_mobile:account},function(retval){
      if(retval.success){
  ...
  function generate_new_password(account,password){   
    $.getJSON('/account/generate_new_password.json',{ email_mobile:account,password:password},function(retval){
      if(retval.success){
