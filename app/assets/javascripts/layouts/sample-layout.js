...
$(document).ready(function(){
 ...
 //  var prizes_container = null
	...
	$('.share-btn').fancybox({
		beforeShow: function(){
			$(".fancybox-skin").css({"backgroundColor":"#fff"});
			var current_share_btn = $(this.element);
			var point 		 = current_share_btn.attr('data');
			var survey_id 	 = current_share_btn.attr('survey_id');
			var scheme_id 	 = current_share_btn.attr('scheme_id');
			share_imgs   = current_share_btn.parents('li').find('a.unfold-btn').attr('prize_src');
