...
class AnswersController < ApplicationController
	...
	def create
		...
		if params[:is_preview]
			...
			answer = Answer.create_answer(params[:is_preview], params[:introducer_id], email, params[:survey_id], params[:channel], params[:_remote_ip], params[:username], params[:password], params[:referrer_domain])
