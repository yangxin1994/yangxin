    ...
    $.extend(PageGuide, {
        ...
        prototype: {
            ...
            init: function() {
                ...
                message.append('<a class="pageguide-close" title="关闭向导">关闭</a>').append('<span class="pageguide-index"></span>').append('<div class="pageguide-content"></div>').append('<a class="pageguide-back" title="上一步">上一步</a>').append('<a class="pageguide-fwd" title="下一步">下一步</a>');
